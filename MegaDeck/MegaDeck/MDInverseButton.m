...
- (void) addLabelText:(NSString*)labelText
{
	if( !auxLabel )
	{
		...
		[auxLabel setTextColor:[UIColor whiteColor]];
...
{
	[auxLabel setBackgroundColor:[self backgroundColor]];
	[auxLabel setTextColor:[self backgroundColor] == [UIColor whiteColor] ? [UIColor blackColor] : [UIColor whiteColor]];
}
...
{
	[self setBackgroundColor:selected ? [UIColor whiteColor] : [UIColor blackColor]];
	[self updateLabel];
